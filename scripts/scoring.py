...
async def execute():
    ...
    query = await conn.prepare(f'SELECT username from user_details_2024 where user_id=$1')

    with open('/Users/ashmitdutta/OPhO/scripts/data/finalrankings.csv', 'a') as f:
        count = 1
